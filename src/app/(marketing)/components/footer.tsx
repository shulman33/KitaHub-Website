...
const navigation = {
  ...
  social: [
    {
      name: "Facebook",
      href: "https://www.facebook.com/share/3LoEDricwdQNYGTj/?mibextid=LQQJ4d",
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/kitahub.io/",
      icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"

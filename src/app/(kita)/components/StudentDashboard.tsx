...
const dummyCourses = [
  { courseName: 'Mathematics III', title: 'Answer Writing', deadline: '02:40:55' },
  { courseName: 'Physics II', title: 'Quiz Preparation', deadline: '01:30:00' },
  { courseName: 'Chemistry I', title: 'Lab Report', deadline: '03:45:10' },
  { courseName: 'Computer Science', title: 'Project Submission', deadline: '05:20:15' },
    ...
    <>
      ...
      <div className=" py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-[40%,auto] mt-[30px] w-full gap-[30px]">
          ...
          <SubmissionStatusWidget assignments={dummyAssignments} />
